...
program
    ...
    .action(async (options) => {
        ...
        if (
            stylingLibraryAnswer &&
            stylingLibraryAnswer.toLowerCase() === 'mui'
        ) {
        ...
        try {
            ...
            if (useSass) {
                insertLine();
                console.log(
                    chalk.magenta(`Adding Sass to the project...`, '\n')
                );
            ...
            if (storeAnswer.toLowerCase() === 'zustand') {
                insertLine();
                console.log(
                    chalk.magenta(`Adding Zustand to the project...`, '\n')
                );
                await addZustandToProject(targetPath);
            } else if (storeAnswer.toLowerCase() === 'redux') {
                insertLine();
                console.log(
                    chalk.magenta(`Adding Redux to the project...`, '\n')
                );
            ...
            if (stylingLibraryAnswer.toLowerCase() === 'mui') {
                insertLine();
                console.log(
                    chalk.magenta(`Adding MUI to the project...`, '\n')
                );
                ...
                insertLine();
                console.log(
                    chalk.magenta(`Adding bootstrap to the project...`, '\n')
                );
            ...
            if (useRouter) {
                insertLine();
                console.log(
                    chalk.magenta(`Adding Router to the project...`, '\n')
                );
                // add router
            ...
            if (usePrettier) {
                ...
                console.log(
                    chalk.magenta(
                        `Configuring Prettier for the project...`,
                        '\n'
                    )
                );
            ...
            if (useFolderStructure) {
                ...
                console.log(
                    chalk.magenta(
                        `Adding folder structure to the project...`,
                        '\n'
                    )
                );
